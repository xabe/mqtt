...
class TemperatureHandlerTest {
  ...
  public void setUp() throws Exception {
    ...
    when(this.config.getString(MQTT_TEMPERATURE_TOPIC)).thenReturn("temperature");
    ...
    this.mqttHandler = new TemperatureHandler(this.consumerRepository, this.objectMapper, this.config);
  }

  @Test
  public void getTopic() throws Exception {
    assertThat(this.mqttHandler.getTopic(), is(notNullValue()));
    assertThat(this.mqttHandler.getTopic(), is("temperature"));
  }
  ...
  public void shouldHandlerMessage() throws Exception {
    ...
    verify(this.consumerRepository).addTemperature(eq(sensorDO));
  }
